"""
STEP 5 — evaluate.py (PPO version)

Run:
    python evaluate.py

evaluate.py — FINAL PPO VERSION
...
if not os.path.exists(model_path + ".zip"):
    ...
    print("Expected path: ./models/best/best_model.zip")
    print("Train PPO first or check your model path.")
    exit(1)
...
# Alternative: load a specific PPO checkpoint
# model = PPO.load("./models/checkpoints/balancebot_ppo_100000_steps", env=env)
