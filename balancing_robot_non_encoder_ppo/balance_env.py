...
WHAT CHANGED FROM v1:
  ...
  UPDATED physical parameters:
    WHEEL_RADIUS = 0.034m   (68.1mm diameter, caliper measured)
    WHEEL_BASE   = 0.233m   (physically measured centre-to-centre)
    MAX_SPEED    = 17.8     (225RPM × 0.758 L298N voltage correction)
    spawn_height = 0.034m   (= wheel radius)
    Body height  = 0.18m    (18cm confirmed)
